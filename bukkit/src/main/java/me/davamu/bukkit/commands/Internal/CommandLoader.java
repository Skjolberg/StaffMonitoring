package me.davamu.bukkit.commands.Internal;
...
import me.davamu.bukkit.commands.MainCommand;
...
public class CommandLoader implements SLLoader {
    ...
    public CommandLoader(CommandTranslatorProvider commandTranslatorProvider, MainModule mainModule) {
        this.commandManager = new BukkitCommandManager(StaffMonitoring.getPlugin().getName());
